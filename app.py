...
# Diccionario de respaldo para nombres
DICCIONARIO_SETS = {
    "10316": "Rivendell",
...
def obtener_nombre(set_id):
    ...
    if sid in DICCIONARIO_SETS: return DICCIONARIO_SETS[sid]
    
    # Intento de búsqueda rápida en Rebrickable
    try:
